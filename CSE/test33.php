...
<?php 
        ...
        else if($typeexam==2)
        {
            ...
            $short_q5 = "SELECT que_desc FROM questions WHERE sub_id=$subj_id and que_marks=2 and (unit_no=1 or unit_no=2 or unit_no=3  or unit_no=4) and que_mode!=4 and exaque_count!= $ques1_id and exaque_count!= $ques2_id and exaque_count!= $ques3_id and exaque_count!= $ques4_id   ORDER BY RAND() LIMIT 1";
            $shortq5_exe = mysqli_query($con,$short_q5);
            $short5 = mysqli_fetch_assoc($shortq5_exe);
            $ques5 = $short5['que_desc'];
            array_push($pushque, $ques5);
